...
* Security Engineer: Designs and implements security systems to protect an organization’s digital assets.
4. Cloud Computing
...
The previous list focuses on abstract technology—things you can’t see or physically touch, like software or cloud networks. However, there are also many hardware-based roles in tech. Hardware refers to the tangible components of a computer or system—things you can physically interact with, such as servers.
...
So, the next time you hear, “She’s good with computers,” you might want to follow up with, “Oh yeah? Does she build servers, fight off cybercriminals, or make AI that’ll one day take over the world?”

Tech isn’t just “computers”—it’s an entire universe of roles, from coding and cybersecurity to designing tiny circuit boards and keeping the cloud from crashing. It’s a vast, dynamic field filled with countless specialized roles—each contributing to the technology we rely on daily. Whether in software, hardware, security, or design, tech professionals shape the digital and physical world around us.
...
Ok, we’re going to take a bit of a detour here.
...
Since binary only uses 0 and 1, when we count past 1, we combine those 0s and 1s to make larger numbers as well. However, each place value represents a power of 2 (1s, 2s, 4s, 8s, 16s, and so on). “Power of 2” refers to how many times you multiply the number 2 by itself. 
...
This is why I wrote this blog. It’s up to all of us (whether you are an AI engineer or a layperson) -to keep a close eye on how AI develops. It’s up to us to question if those developments are ethical to all life (both flora and fauna) in every part of the world. It’s up to our governments to create (and citizens to demand) appropriate regulations to keep AI safe and positive. Or else, we may create a world that we won’t like. 
